...
// Fork of official 2.43
VERSION = "2.43.bfdfork";
...
module MakeBox( box )
{
    ...
    module MakeLayer( component, layer = "" )
    {
        ...
        m_cutout_size_frac_aligned = __value( component, CMP_CUTOUT_DEPTH, default = 0.25 );
        m_cutout_size_frac_perpindicular = __value( component, CMP_CUTOUT_WIDTH, default = 0.50 );
	m_cutout_botttom_size_frac = __value( component, CMP_CUTOUT_BOTTOM_PCT, default = 0.80 );
